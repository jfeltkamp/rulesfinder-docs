...
RulesFinder ist eine Beteiligungs- und Argumentations-Software für das gemeinsame aushandeln von Verträgen. Die Software unterstützt die Teilnahme aller Stakeholder[^1] an Vertragsverhandlungen. Sie hilft mit bewährten heuristischen Methoden in jedem verhandelten Punkt optimierte Regelungen zu finden und vereinfacht faire Entscheidungen. Jede Regel oder Vertragsklausel kann einzeln verhandelt und optimiert werden, ohne dass die zu regelnden Problemlagen aus dem Blick geraten.

Als "Verträge" bezeichnen wir hier alle Texte, welche praktische Normen zu einem geschlossenen Regelwerk zusammenfassen. Also:
...
* und anderes, z.B. Netiquette, Spielregeln, Baderegeln, Anstandsregeln.
...
Technisch ist RuFi eine Drupal-Distribution. Das heißt, dass RuFi zusammen mit dem Drupal Core als Framework, mit einem Set von Zusatzmodulen und mit einer vordefinierten Software-Konfiguration installiert wird.

Drupal ist ein PHP-basiertes Content-Management-System, welches hohe Sicherheitsstandards erfüllt und zugleich flexibel und leicht modular erweitert werden kann. Die Erweiterbarkeit und Flexibilität vererben sich an den RulesFinder, weil dieser den Code und die Coding-Standards von Drupal übernimmt. 

Für die Zukunft sind einige Erweiterungen der RuFi-Software geplant. Z.B. ein erweitertes Event-Logging, oder ein Workflow-Management, die als Zusatzmodule installiert werden können und den Funktionsumfang erweitern. Wir sind optimistisch, dass Open-Source-EntwicklerInnen eigene Ideen und Beiträge beisteuern, welche die Nützlichkeit dieser Software weiter erhöhen. 
